...
def init():
    global model
    model_path = os.path.join(os.getenv('AZUREML_MODEL_DIR'),'simpsons-classification-pytorch','model.pth')
    labels_path = os.path.join(os.getenv('AZUREML_MODEL_DIR'),'simpsons-classification-pytorch', 'labels.txt')
